...
const suites=[['unit',['--test','scripts/tests/*.test.mjs']],
 ...['validate-records','validate-sources','validate-relationships','validate-assets','check-links','check-identifiers','check-book-sync','validate-elements','validate-ionisation','validate-ionisation-charts','validate-ame2020','validate-hydrogen-balmer','validate-proposed-elements','validate-advanced-completion','validate-unified-gap-analysis','validate-panel-images','validate-state-flow'].map(s=>[s,['scripts/'+s+'.mjs']])];
